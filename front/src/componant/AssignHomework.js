  ...
  const getAttendance = async () => {
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_BACKEND_BASE_URL}/assignHomeWork`
      );
      if (res.status === 200) {
        if (userData.roll === "Admin") {
    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/assignHomeWork/delete/` +
          id
        );
        if (res.status === 200) {
          getAttendance();
          ...
          <div className="content">
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Assign Homework </li>
              </ol>
            </nav>
            <div className="content-page-header content-page-headersplit">
              ...
              <div className="list-btn">
                <ul>
                  <li>
                    <Link to={"/addassignhomework"} className="btn btn-primary">
            ...
            <div className="col-lg-5 mt-3">
              <div className="form-group">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search Assign Homework Title"
                        ...
                        currentItems.map((dataa, index) => {
                          return (
                            <tr key={index}>
                              ...
                              <td>{dataa.description.split("").slice(0, 10).join("") + "..."}</td>
                              <td>
                              ...
                              <td>
                                <div className="table-actions d-flex">
                                  <Link
                                    ...
                                    to={`/editassignhomework/${dataa.id}`}
                                  >
                                    {" "}
