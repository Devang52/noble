...
export default function HomeworkStatus() {
  ...
  const getAssignHomeworkData = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/assignHomeWork`);
      if (res.status === 200) {
        if (userData.roll === 'Admin') {
          ...
          <div className="content">
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Homework Status</li>
              </ol>
            </nav>
            ...
            <div className="col-lg-5 mt-3">
              <div className="form-group">
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search Homework Status"
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <div className="table-actions d-flex">
                                  <Link className="delete-table me-2" to={`/createhomeworkstatus/${dataa.id}`}> <i class="fa-solid fa-eye"></i> </Link>
                                </div>
                              </td>
                            </tr>
                          );
