...
function AddNotice() {
  ...
  const getStudentData = async (id_branch, id_board, id_medium, id_standard, id_batch) => {
    // console.log(id_branch, id_board, id_medium, id_standard, id_batch);
    try {
  ...
  const headleSubmit = async (e) => {
    ...
    try {
      ...
      if (!trimmedExam.name || !values.name || !values.files) {
        Swal.fire({
          title: 'Please enter Notice Title or Files',
          icon: 'warning',
        });
      } else {
        ...
        const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/createnotice`, formDataObject)
        if (res.status === 200) {
          // Successful request
          Swal.fire({
            icon: 'success',
  ...
  const handleInputChange = (e, studentId) => {
    ...
    if (name == 'allstudent' || name === 'student') {
      setValues((prevValues) => {
        if (checked) {
          return { ...prevValues, id_student: [...prevValues.id_student, studentId] };
        } else {
          return { ...prevValues, id_student: prevValues.id_student.filter(id => id !== studentId) };
        }
      });
    } else {
      setValues((prevValues) => ({
              ...
              <div className="row">
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><NavLink to="/notice">Notice </NavLink>/</li>
                    <li className="breadcrumb-item active" aria-current="page">Add Notice</li>
                  </ol>
                </nav>
                  ...
                  <div className="row mt-3">
                      ...
                      <div className='from-group'>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            getStudentData(values.id_branch, value);
                          }}
                        >
                      ...
                      <div className='from-group'>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            getStudentData(values.id_branch, values.id_board, value);
                          }}
                        >
                      ...
                      <div className='from-group'>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            getStudentData(values.id_branch, values.id_board, values.id_medium, value);
                          }}
                        >
                      ...
                      <div className='from-group mt-4'>
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            getStudentData(values.id_branch, values.id_board, values.id_medium, values.id_standard, value);
                          }}
                        >
                    ...
                    <div className="col-lg-12">
                      <div className="btn-path">
                        <Link to={'/notice'} className="btn btn-cancel me-3">Back</Link>
