    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/inquiry/delete/` + id
        );
        if (res.status === 200) {
          getInquiryData();
          Swal.fire({
            title: "Deleted!",
            text: "This inquiry has been deleted.",
            icon: "success",
          ...
          <div className="content">
            ...
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Inquiry</li>
              </ol>
            </nav>
            {/* {/ <!-- [ breadcrumb ] end --> /} */}
            <div className="content-page-header content-page-headersplit">
              ...
              <div className="list-btn">
                <ul>
                  <li>
                    <Link to={"/createinquiry"} className="btn btn-primary">
                              ...
                              <td>
                                <div className="table-actions d-flex">
                                  <Link
                                    ...
                                    to={`/inquiryview/${dataa.id}`}
                                  >
                                    <i className="fa-solid fa-eye"></i>
                                  </Link>
                                  <Link
                                    className="delete-table me-2"
                                    to={`/editinquiry/${dataa.id}`}
                                  >
                                    {" "}
                                    <i className="fas fa-edit"></i>{" "}
                                  </Link>
                                  <div
                                    className="delete-table delll me-2"
                                  ...
                                  <Link
                                    className="delete-table me-2"
                                    target="_blank"
                                    to={`https://wa.me/${dataa.contact_1}?text=Your children are not coming today because of`}
                                  >
