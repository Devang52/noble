...
export default function Medium() {
    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/delete-Medium/` + id
        );
        if (res.status === 200) {
          getMediumData();
          Swal.fire({
            title: "Deleted!",
            text: "This Medium has been deleted.",
            icon: "success",
  ...
  const filterDataBySearch = (data) => {
    return data.filter((item) => {
      ...
      return medium.includes(searchQueryLower);
    });
  };
          ...
          <div className="content">
            ...
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Medium</li>
              </ol>
            </nav>
            {/* {/ <!-- [ breadcrumb ] end --> /} */}
            ...
            <div className="d-flex justify-content-between">
              ...
              <div className="list-btn mt-2">
                <ul>
                  <li>
                    <Link to={"/createmedium"} className="btn btn-primary">
