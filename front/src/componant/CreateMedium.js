...
export default function CreateMedium() {
    ...
    const headleSubmit = (e) => {
        ...
        try {
            ...
            if (!values || !trimmedMedium.medium || !values.medium || !values.id_branch || !values.id_board || values.id_board === "--select Board--") {
                Swal.fire({
                    title: "Please enter all data",
                    icon: "warning",
                });
            } else {
                axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/create-medium`, values)
                    .then(res => {
                        console.log(res);
                        Swal.fire({
                            icon: "success",
                            title: "Medium Inserted Successfully",
                            timer: 1500,
                        }).then(() => {
                            navigate('/medium');
                        });
                            ...
                            <div className="row">
                                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><NavLink to="/area">Medium </NavLink>/</li>
                                        <li className="breadcrumb-item active" aria-current="page">Add Medium</li>
                                    </ol>
                                </nav>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 mt-3">
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => {
                                                    setBoard([])
                                                    getBoardData(e.target.value, values.id_branch)
                                                    handleInputChange(e);
                                                }}
                                            >
                                        ...
                                        <div className="col-lg-6 mt-3">
                                            ...
                                            >
                                                <option selected value="--select Board--">
                                                    Select Board
                                                </option>
                                                {board.length > 0 &&
                                                    board.map((data) => (
                                        ...
                                        <div className="col-lg-6 mt-3">
                                            <div className="form-group">
                                                <label>Medium</label>
                                                <input type="text" className="form-control" placeholder="Enter Medium"
