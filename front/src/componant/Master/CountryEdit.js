...
const CountryEdit = () => {
    ...
    const getCountryIdData = async () => {
        try {
            const res = await axios.get(
                `${process.env.REACT_APP_BACKEND_BASE_URL}/getcountry/${id}`
            );
            if (res.status === 200) {
                setCountry({ ...country, country: res.data.data[0].country });
            } else {
                setCountry([]);
            }
        } catch (err) {
        ...
        try {
            ...
            if (!trimmedCountry.country) {
                ...
                const res = await axios.put(
                    `${process.env.REACT_APP_BACKEND_BASE_URL}/country/update/${id}`,
                    trimmedCountry
                );
                            ...
                            <div className="row">
                                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><NavLink to="/country">Country </NavLink>/</li>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="form-group">
                                                ...
                                                <input
                                                    ...
                                                    value={country.country || ''} // Use country.country here
                                                />
