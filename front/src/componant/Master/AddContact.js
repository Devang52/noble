...
export default function AddContact() {
    ...
    const headleSubmit = async (event) => {
        ...
        try {
            ...
            if (!trimContact.email || !trimContact.number || !trimContact.address) {
                Swal.fire({
                ...
                const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/addContactUs`, trimContact)
                if (res.status === 200 && res.data.data) {
                    Swal.fire({
                        icon: "success",
                        title: "Contact Us Inserted Successfully",
                        timer: 1500,
                    }).then(() => {
                        navigate('/contactus');
                    });
                    ...
                    Swal.fire({
                        title: 'Contact Us  Insertion Failed',
                        icon: 'error',
                    });
                }
            }
                            ...
                            <div className="row">
                                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><NavLink to="/contactus">Contact Us </NavLink>/</li>
                                ...
                                <div className="col-lg-12 col-sm-12">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="btn-path">
                                            <Link to={'/contactus'} className="btn btn-cancel me-3">Back</Link>
