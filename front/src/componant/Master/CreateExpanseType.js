    ...
    try {
      ...
      if (!trimmedExpanseType.expanse_type) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/create-expanse-type`,
          trimmedExpanseType
        );
        if (res.status === 200 && res.data.data) {
          ...
          Swal.fire({
            icon: "success",
            title: "Expense Type Inserted Successfully",
            timer: 1500,
          }).then(() => {
          ...
          Swal.fire({
            title: 'Expense Type insertion failed',
            icon: 'error',
          });
        }
      }
              ...
              <div className="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Expense Type</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
...
export default CreateExpanseType;