    ...
    try {
      ...
      if (!trimmedShift.shift) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/create-shift`,
          trimmedShift
        );
        ...
        if (res.status === 200 && res.data.data) {
          ...
          Swal.fire({
            icon: 'success',
            title: 'Shift details Inserted Successfully',
            timer: 1500,
          }).then(() => {
            navigate('/shift');
          });
              ...
              <div className="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Shift</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
                <div className="col-lg-12 col-sm-12">
                  ...
                  <div className="col-lg-6">
                    <div className="btn-path">
                      <Link to={'/shift'} className="btn btn-cancel me-3">
                        Back
                      </Link>
