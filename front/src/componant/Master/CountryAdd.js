  ...
  const headleSubmit = async (event) => {
    ...
    try {
      ...
      if (!trimmedCountry.country) {
        ...
        const res = await axios.post(`${process.env.REACT_APP_BACKEND_BASE_URL}/country`, trimmedCountry);
                    ...
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        <div className="btn-path">
                          <Link to={'/country'} className="btn btn-cancel me-3">Back</Link>
                          <button type="submit" className="btn btn-submit" onClick={headleSubmit}>Submit</button>
                        </div>
                      </div>
                    </div>
                  </div>
