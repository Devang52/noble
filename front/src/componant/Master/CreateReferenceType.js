...
export default function CreateReferenceType() {
    ...
    try {
      ...
      if (!trimmedReferanceType.name) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/create-referencetype`, trimmedReferanceType
        );

        if (res.status === 200 && res.data.data) {
          Swal.fire({
            icon: "success",
            title: "Reference type Inserted Successfully",
            timer: 1500,
          }).then(() => {
          ...
          Swal.fire({
            title: 'Reference insertion failed',
            icon: 'error',
          });
        }
      }
              ...
              <div class="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Reference Type</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
                <div class="col-lg-12 col-sm-12">
                  <div class="content-page-header">
                    <h5>Add Reference Type</h5>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
