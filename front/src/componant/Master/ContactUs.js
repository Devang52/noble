...
export default function ContactUs() {
    ...
    const getContact = async () => {
        try {
            const res = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/getContactUs`)
            if (res.status === 200) {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (result.isConfirmed) {
                const res = await axios.delete(`${process.env.REACT_APP_BACKEND_BASE_URL}/deleteContactUs/` + id)
                if (res.status === 200) {
                    getContact();
                    Swal.fire({
                        title: "Deleted!",
                    ...
                    <div className="content">
                        ...
                        <div class="content-page-header content-page-headersplit">
                            ...
                            <div class="list-btn">
                                <ul>
                                    <li>
                                        <Link class="btn btn-primary" to={'/addcontact'}><i class="fa fa-plus me-2"></i>Create</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
