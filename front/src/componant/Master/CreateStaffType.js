    ...
    try {
      ...
      if (!trimmedStaffType.staff_type) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/create-staff-type`,
          trimmedStaffType
        );
        ...
        if (res.status === 200 && res.data.data) {
          ...
          Swal.fire({
            icon: "success",
            title: "Staff Type Inserted Successfully",
            timer: 1500,
          }).then(() => {
            navigate('/stafftype');
          });
          ...
          Swal.fire({
            title: 'Staff Type insertion failed',
            icon: 'error',
          });
        }
      }
              ...
              <div className="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Staff Type</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
                <div className="col-lg-12 col-sm-12">
                  <div className="content-page-header">
                    <h5>Add Staff Type</h5>
                  </div>
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="form-group">
                        <label>Staff Type</label>
                        <input type="text" className="form-control" placeholder="Staff Type"
