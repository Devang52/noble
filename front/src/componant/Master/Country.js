...
const Country = () => {
  ...
  useEffect(() => {
    const filtered = filterDataBySearch(country ?? []);
    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/country/delete/` + id
        );
        if (res.status === 200) {
          getCountryData();
          Swal.fire({
          ...
          <div className="content">
            ...
            <div className="d-flex justify-content-between">
              ...
              <div className="list-btn mt-4">
                <ul>
                  <li>
                    <Link to={"/addcountry"} className="btn btn-primary">
                      ...
                      {currentItems.length === 0 ? (
                        ...
                        currentItems.map((dataa, index) => (
                          <tr key={index}>
                            ...
                            <td>
                              {dataa.country.charAt(0).toUpperCase() +
                                dataa.country.slice(1)}
                            </td>
                            <td>
