    ...
    try {
      ...
      if (!trimmedIncomeType.income_type) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/create-income-type`,
          trimmedIncomeType
        );
        ...
        if (res.status === 200 && res.data.data) {
          ...
          Swal.fire({
            icon: "success",
            title: "Income Type Inserted Successfully",
            timer: 1500,
          }).then(() => {
            navigate('/incometype');
          });
          ...
          Swal.fire({
            title: 'Income Type insertion failed',
            icon: 'error',
          });
        }
      }
              ...
              <div className="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Income Type</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
                <div className="col-lg-12 col-sm-12">
                  <div className="content-page-header">
                    <h5>Add Income Type</h5>
                  </div>
                  <div className="row">
