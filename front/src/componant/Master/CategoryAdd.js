        ...
        try {
            ...
            if (!trimmedCity.category_name) {
                ...
                const res = await axios.post(
                    `${process.env.REACT_APP_BACKEND_BASE_URL}/category`, category);
                ...
                if (res.status === 200 && res.data.data) {
                    ...
                    Swal.fire({
                        title: "Category insertion failed",
                        icon: "error",
                    });
                }
            }
                            ...
                            <div className="row">
                                ...
                                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item"><NavLink to="/category">Category </NavLink>/</li>
                                        ...
                                        <div className="col-lg-6">
                                            <div className="form-group">
                                                ...
                                                <div className="btn-path">
                                                    <Link to={'/category'} className="btn btn-cancel me-3">Back</Link>
