    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/classroom/delete/` + id
        );
        if (res.status === 200) {
          getClassroomData();
          Swal.fire({
            title: "Deleted!",
            text: "This Classroom has been deleted.",
            icon: "success",
          ...
          <div class="content">
            ...
            <div className="d-flex justify-content-between">
              ...
              <div class="list-btn mt-4">
                <ul>
                  <li>
                    <Link to={"/createclassroom"} class="btn btn-primary">
