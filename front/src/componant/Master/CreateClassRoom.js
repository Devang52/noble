    ...
    try {
      ...
      if (!trimmedClass.name) {
        ...
        const res = await axios.post(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/classroom`,
          trimmedClass
        );
        ...
        if (res.status === 200 && res.data.data) {
          ...
          Swal.fire({
            icon: "success",
            title: "Class Room Inserted Successfully",
            timer: 1500,
          }).then(() => {
            navigate('/class');
          });
          ...
          Swal.fire({
            title: 'Class Room insertion failed',
            icon: 'error',
          });
        }
      }
              ...
              <div class="row">
                ...
                <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Add Class Room</li>
                  </ol>
                </nav>
                {/* {/ <!-- [ breadcrumb ] end --> /} */}
