          ...
          <div className="content">
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Gujarati Report</li>
              </ol>
            </nav>
            <div className="content-page-header content-page-headersplit">
              <h5>Gujarati Report</h5>
              <div className="list-btn">
                <ul>
                  <li>
                    <Link
                      to={"/creategujaratireport"}
              ...
              <div className="col-lg-4 mt-3">
                <div className="form-group">
                  <input
                    ...
                    type="text"
                    placeholder="Search Gujarati Report"
                              ...
                              <td>
                                <div className="table-actions d-flex">
                                  <Link
                                    ...
                                    to={`/editgujaratireport/${dataa.id}`}
                                  >
                                    {" "}
