...
export default function CreateMathsReport() {
            ...
            const newData = prevValues.map(student => {
                if (student.id_student === studentId) {
                    return {
                        ...
                        plus_s: name === "plus_s" ? (checked ? "yes" : "no") : student.plus_s,
                        plus_p: name === "plus_p" ? (checked ? "yes" : "no") : student.plus_p,
                        minus_s: name === "minus_s" ? (checked ? "yes" : "no") : student.minus_s,
                        minus_p: name === "minus_p" ? (checked ? "yes" : "no") : student.minus_p,
                        multiplied_by_s: name === "multiplied_by_s" ? (checked ? "yes" : "no") : student.multiplied_by_s,
                        multiplied_by_p: name === "multiplied_by_p" ? (checked ? "yes" : "no") : student.multiplied_by_p,
                        divided_by_s: name === "divided_by_s" ? (checked ? "yes" : "no") : student.divided_by_s,
                        divided_by_p: name === "divided_by_p" ? (checked ? "yes" : "no") : student.divided_by_p,
                        percent: name === "percent" ? (checked ? "yes" : "no") : student.percent,
                        two_root: name === "two_root" ? (checked ? "yes" : "no") : student.two_root,
                        three_root: name === "three_root" ? (checked ? "yes" : "no") : student.three_root,
                        ab_plus: name === "ab_plus" ? (checked ? "yes" : "no") : student.ab_plus,
                        ab_square: name === "ab_square" ? (checked ? "yes" : "no") : student.ab_square,
                        axbxc_plus: name === "axbxc_plus" ? (checked ? "yes" : "no") : student.axbxc_plus,
                        ab_bc_plus: name === "ab_bc_plus" ? (checked ? "yes" : "no") : student.ab_bc_plus,
                        simplification: name === "simplification" ? (checked ? "yes" : "no") : student.simplification,
                    };
                }
                return student;
            });
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const res = await axios.post(
                `${process.env.REACT_APP_BACKEND_BASE_URL}/createmathsreport`,
                dataWithStudentId
            );
            ...
            if (res.status === 200) {
                ...
                Swal.fire({
                    icon: "success",
                    title: "Maths Report insertion successful",
                    timer: 1500,
                }).then(() => {
                    navigate('/mathsreport');
                });
            } else {
                Swal.fire({
                    title: "Maths Report insertion failed",
                    icon: "error",
                });
            }
        } catch (err) {
    ...
    const options = [
        { value: "Total Marks", label: "Total Marks" },
        { value: "Simple Plus (+)", label: "Simple Plus (+)" },
        { value: "Point Plus (+)", label: "Point Plus (+)" },
        { value: "Simple Minus ( - )", label: "Simple Minus ( - )" },
        { value: "Point Minus ( - )", label: "Point Minus ( - )" },
        { value: "Simple Multiplied by ( x )", label: "Simple Multiplied by ( x )" },
        { value: "Point Multiplied by ( x )", label: "Point Multiplied by ( x )" },
        { value: "Simple Divided by ( ÷ )", label: "Simple Divided by ( ÷ )" },
        { value: "Point Divided by ( ÷ )", label: "Point Divided by ( ÷ )" },
        { value: "Percent ( % )", label: "Percent ( % )" },
        { value: "2√x", label: "2√x" },
        { value: "3√x", label: "3√x" },
        { value: "( a + b )", label: "( a + b )" },
        { value: "( a² + b² )", label: "( a² + b² )" },
        { value: "ax² + bx + c", label: "ax² + bx + c" },
        { value: "( a + b )( b + c )", label: "( a + b )( b + c )" },
                    ...
                    <div className="content">
                        <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item"><NavLink to="/mathsreport">Maths Report </NavLink>/</li>
                                <li className="breadcrumb-item active" aria-current="page">Add Maths Report</li>
                            </ol>
                        </nav>
                        <div className="content-page-header content-page-headersplit">
                            <h5>Add Maths Report</h5>
                        </div>
                        <div className="row">
                            ...
                            <div className="col-12">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                {selectedValues.map((value, index) => (
                                                    <th key={index} style={{ padding: '15px 40px' }}>{value}</th>
                                                ))}
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                filteredStudent.map((dataa, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        {selectedValues.map((value, columnIndex) => {
                                                            ...
                                                            } else if (value === "Simple Multiplied by ( x )") {
                                                                return (
                                                                    <td key={columnIndex}>
                                                                        <div className="siderbar-toggle">
                                                                            Done
                                                            ...
                                                            } else if (value === "Point Multiplied by ( x )") {
                                                                return (
                                                                    <td key={columnIndex}>
                                                                        <div className="siderbar-toggle">
                                                                            Done
                                                            ...
                                                            } else if (value === "Simple Divided by ( ÷ )") {
                                                                return (
                                                                    <td key={columnIndex}>
                                                                        <div className="siderbar-toggle">
                                                                            Done
                                                            ...
                                                            } else if (value === "Point Divided by ( ÷ )") {
                                                                return (
                                                                    <td key={columnIndex}>
                                                                        <div className="siderbar-toggle">
                                                                            Done
                                ...
                                <div className="col-lg-12">
                                    <div className="btn-path">
                                        <Link to={"/mathsreport"} className="btn btn-cancel me-3">
                                            Back
                                        </Link>
                                        <button
                                            type="submit"
