...
const EditEnglishReport = () => {
  ...
  const getAddEnglishData = async () => {
    try {
      const res = await axios.get(`${process.env.REACT_APP_BACKEND_BASE_URL}/getbyidenglishreport/${id}`);
      if (res.status === 200) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.put(
        `${process.env.REACT_APP_BACKEND_BASE_URL}/editenglishreport/${id}`,
        data
      );
      ...
      if (res.status === 200) {
        ...
        Swal.fire({
          icon: "success",
          title: "English Report updated successfully",
          timer: 1500,
        }).then(() => {
        ...
        Swal.fire({
          title: "English Report update failed",
          icon: "error",
        });
      }
    } catch (err) {
    ...
    try {
      ...
      if (result.isConfirmed) {
        const res = await axios.delete(
          `${process.env.REACT_APP_BACKEND_BASE_URL}/deleteenglishreport/` + id
        );
        if (res.status === 200) {
          if (data.length === 1) {
            setData([]);
          ...
          Swal.fire({
            title: "Deleted!",
            text: "This English Report has been deleted.",
            icon: "success",
          ...
          <div className="content">
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Edit English Report</li>
              </ol>
            </nav>
            <div className="content-page-header content-page-headersplit">
              <h5>Edit English Report</h5>
            </div>
            <div className="row">
                  ...
                  <table className="table datatable">
                    <thead>
                      <tr>
                        ...
                        <th>'E' Sound</th>
                        <th>'I' Sound</th>
                        <th>Reading Pattern</th>
                        <th>Hand Writing</th>
                        <th>Capital Letter Problemd</th>
                        <th>Basic Words Spelling</th>
                        <th>Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                              ...
                              <div className="siderbar-toggle">
                                ...
                                <label className="switch">
                                  <input
                                    ...
                                    checked={dataa.three_letter_words === 'yes'}
                                    onChange={(e) =>
                                      handleInputChange(e, dataa.id)
                                    }
                                  />
                              ...
                              <div className="siderbar-toggle">
                                ...
                                <label className="switch">
                                  <input
                                    ...
                                    checked={dataa.capital_letter_problem === 'yes'}
                                    onChange={(e) =>
                                      handleInputChange(e, dataa.id)
                                    }
                                  />
                              ...
                              <div className="siderbar-toggle">
                                ...
                                <label className="switch">
                                  <input
                                    ...
                                    checked={dataa.basic_words_spelling === 'yes'}
                                    onChange={(e) =>
                                      handleInputChange(e, dataa.id)
                                    }
                                  />
...
export default EditEnglishReport
