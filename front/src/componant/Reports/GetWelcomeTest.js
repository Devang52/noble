...
const GetWelcomeTest = () => {
  ...
  const handleSearch = (e) => {
    ...
    setFilteredData(filterDataBySearch(data, value));
  };
          ...
          <div className="content">
            <nav aria-label="breadcrumb" style={{ '--bs-breadcrumb-divider': 'none' }}>
              <ol className="breadcrumb">
                ...
                <li className="breadcrumb-item active" aria-current="page">Welcome Report</li>
              </ol>
            </nav>
            <div className="content-page-header content-page-headersplit">
              ...
              <div className="list-btn">
                <ul>
                  <li>
                    <Link to={"/welcometest"} className="btn btn-primary">
